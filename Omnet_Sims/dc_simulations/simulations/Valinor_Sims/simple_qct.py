...
incast_scale = 40      # Incast scales
bg_inter_arrival_mult = 19.75    # BG inter-arrival multipliers
incast_inter_arrival_mult = 0.071
...
for category in CATEGORIES:
    ...
    try:
        ...
        # Storing the information of the flows
        flows_temp = dict()
        flow_app_mapper = dict()
        with open(directory + file_name) as csv_file:
        ...
        with open(directory4 + file_name) as csv_file:
            csv_reader = csv.reader(csv_file, delimiter=',')
            first_line = True
            row1 = None
            row_counter = None
        ...
        with open(directory2 + file_name) as csv_file:
            csv_reader = csv.reader(csv_file, delimiter=',')
            first_line = True
            row1 = None
            for row in csv_reader:
        ...
        with open(directory3 + file_name) as csv_file:
            csv_reader = csv.reader(csv_file, delimiter=',')
            first_line = True
            row1 = None
            for row in csv_reader:
        ...
        with open(directory5 + file_name) as csv_file:
            csv_reader = csv.reader(csv_file, delimiter=',')
            first_line = True
            row1 = None
            row_counter = None
        ...
        print('all,{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}\n '
              ...
              'bursty,{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}\n'
              'background,{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}'.format(
            num_all_flows_requested,
            num_all_flows_started,
            num_all_flows_ended,
            ...
            num_bursty_flows_requested,
            num_bursty_flows_started,
            num_bursty_flows_ended,
            ...
            num_background_flows_requested,
            num_background_flows_started,
            num_background_flows_ended,
