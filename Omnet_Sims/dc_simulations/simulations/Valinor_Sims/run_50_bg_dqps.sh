...
mkdir logs/dctcp_valinor_50_bg_dqps
cp results/*.out logs/dctcp_valinor_50_bg_dqps/
...
mkdir logs/dctcp_valinor_las_50_bg_dqps
cp results/*.out logs/dctcp_valinor_las_50_bg_dqps/
...
opp_runall -j50 ../../src/dc_simulations -m -u Cmdenv -c Swift_Valinor -n ..:../../src:../../../inet/src:../../../inet/examples:../../../inet/tutorials:../../../inet/showcases --image-path=../../../inet/images -l ../../../inet/src/INET omnetpp_50_bg_dqps.ini
do_extract swfit_valinor
mkdir logs/swfit_valinor_50_bg_dqps
cp results/*.out logs/swfit_valinor_50_bg_dqps/
...
mkdir logs/tcp_valinor_50_bg_dqps
cp results/*.out logs/tcp_valinor_50_bg_dqps/
...
mkdir logs/tcp_valinor_las_50_bg_dqps
cp results/*.out logs/tcp_valinor_las_50_bg_dqps/
