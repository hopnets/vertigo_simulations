...
mkdir logs/dctcp_vertigo_50_bg_fsize
cp results/*.out logs/dctcp_vertigo_50_bg_fsize/
...
mkdir logs/dctcp_vertigo_las_50_bg_fsize
cp results/*.out logs/dctcp_vertigo_las_50_bg_fsize/
...
opp_runall -j50 ../../src/dc_simulations -m -u Cmdenv -c Swift_Vertigo -n ..:../../src:../../../inet/src:../../../inet/examples:../../../inet/tutorials:../../../inet/showcases --image-path=../../../inet/images -l ../../../inet/src/INET omnetpp_50_bg_dfsize.ini
do_extract swfit_vertigo
mkdir logs/swfit_vertigo_50_bg_fsize
cp results/*.out logs/swfit_vertigo_50_bg_fsize/
...
mkdir logs/tcp_vertigo_50_bg_fsize
cp results/*.out logs/tcp_vertigo_50_bg_fsize/
...
mkdir logs/tcp_vertigo_las_50_bg_fsize
cp results/*.out logs/tcp_vertigo_las_50_bg_fsize/
